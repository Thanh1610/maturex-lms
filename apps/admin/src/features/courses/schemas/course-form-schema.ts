...
export const courseFormSchema = z.object({
  ...
  description: z
    .string()
    .min(10, "Tổng quan khóa học phải có ít nhất 10 ký tự"),
  category: z.string().min(2, "Vui lòng chọn hoặc nhập danh mục khóa học"),
  teacher: z
    .string()
    .min(2, "Vui lòng nhập tên giảng viên/người phụ trách")
    .max(100, "Tên giảng viên không được quá 100 ký tự"),
  duration: z.string().min(1, "Vui lòng nhập thời lượng dự kiến (VD: 2 giờ)"),
